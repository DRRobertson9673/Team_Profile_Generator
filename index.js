...
// code to gather information on and create manager
...
// code to gather information on and create engineer
function createEngineer(team) {
    inquirer.prompt([
        ...
        // Initialise Engineer class to create engineer object
...
// code to gather info on and create intern
function createIntern(team) {
    inquirer.prompt([
        ...
        // Initialise Intern class to create intern object
...
// code to add additional members to team
...
// code to begin creating a new team
function start() {
